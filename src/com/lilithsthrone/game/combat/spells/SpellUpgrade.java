...
public enum SpellUpgrade {
	...
	FIREBALL_1(true,
			...
			null, Util.newArrayListOfValues(
					"Fireball now applies Lingering Flames for [style.colourGood(3 turns)]")),
	FIREBALL_2(2,
			SpellSchool.FIRE,
			...
			null, Util.newArrayListOfValues(
					"Fires a [style.colourGood(second)] Fireball at a random target")),
	FIREBALL_3(5,
			SpellSchool.FIRE,
			...
			null, Util.newArrayListOfValues(
					"Fires multiple Fireballs at [style.colourExcellent(all enemies)] at once.")),
	...
	CLOAK_OF_FLAMES_3(2,
			...
			null, Util.newArrayListOfValues(
					"<b>Melee</b> or <b>unarmed</b> attackers take <b>15</b> [style.colourFire(Fire Damage)]")),
	...
	RAIN_CLOUD_1(true,
			...
			null, Util.newArrayListOfValues(
					"Rain Cloud additionally applies",
                                        "<b>-25</b> [style.boldCold(Cold shielding)],",
                                        "Ice Shard [style.boldExcellent(critically hits)] targets affected by Deep Chill")),
	RAIN_CLOUD_2(3,
			SpellSchool.WATER,
			"rain_cloud_downpour",
			"Downpour",
			...
			null, Util.newArrayListOfValues(
					"Rain Cloud now additionally applies",
                                        "<b>-25</b> "+Attribute.DAMAGE_FIRE.getColouredName("b"),
					"<b>-15</b> "+Attribute.DAMAGE_POISON.getColouredName("b"))),
	RAIN_CLOUD_3(5,
			SpellSchool.WATER,
	...
	POISON_VAPOURS_1(true,
			...
			null, Util.newArrayListOfValues(
					"Choking Haze applies",
                                        "<b>-6</b> "+Attribute.MAJOR_ARCANE.getColouredName("b"),
                                        "<b>-20</b> "+Attribute.DAMAGE_SPELLS.getColouredName("b"))),
	POISON_VAPOURS_2(2,
			SpellSchool.AIR,
	...
	POISON_VAPOURS_3(5,
			...
			null, Util.newArrayListOfValues(
					"Arcane Sickness drains",
                                        "<b>-20</b> "+Attribute.SPELL_COST_MODIFIER.getColouredName("b"),
                                        "<b>25</b> "+Attribute.MANA_MAXIMUM.getColouredName("b")+"",
                                        "per turn")),
	...
	VACUUM_1(true,
			...
			null, Util.newArrayListOfValues(
					...
					"and fires a [style.colourGood(second)] Vacuum at a random target")),
	VACUUM_2(3,
			SpellSchool.AIR,
			"vacuum_suction",
			"Suction",
	...
	PROTECTIVE_GUSTS_1(true,
			...
			null, Util.newArrayListOfValues(
					"Protective Gusts adds",
                                        "<b>+10</b> "+Attribute.MAJOR_PHYSIQUE.getColouredName("b"),
					"<b>+25</b> "+Attribute.CRITICAL_DAMAGE.getColouredName("b"))),
	PROTECTIVE_GUSTS_2(5,
			SpellSchool.AIR,
			...
			null, Util.newArrayListOfValues(
					"[style.colourActionPoints(Strikes)] [style.boldExcellent(critically hit)]",
                                        "while Focused Blast is active")),
	PROTECTIVE_GUSTS_3(3,
			SpellSchool.AIR,
			...
			null, Util.newArrayListOfValues(
					"Protective Gusts now lasts",
                                        "for [style.boldExcellent(8 turns)]")),
	...
	ELEMENTAL_AIR_1(true,
			...
			null, Util.newArrayListOfValues(
					"[style.colourTerrible(All enemies suffer)] <b>-5</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b"))),
	ELEMENTAL_AIR_2(5,
			SpellSchool.AIR,
	...
	SLAM_2(2,
			...
			null, Util.newArrayListOfValues(
					"Applies <b>25</b> "+Attribute.DAMAGE_PHYSICAL.getColouredName("b")+" per turn for as long Ground Shake is active")),
	SLAM_3(5,
			SpellSchool.EARTH,
			"slam_earthquake",
			"Earthquake",
	...
	STONE_SHELL_3(5,
			...
			null, Util.newArrayListOfValues(
					"[style.colourExcellent(All enemies)] take <b>100</b> "+Attribute.DAMAGE_PHYSICAL.getColouredName("b")+" when Stone Shell ends")),
	...
	ARCANE_AROUSAL_2(3,
			...
			null, Util.newArrayListOfValues(
					"Dirty Promises applies ",
                                        "<b>10</b> "+Attribute.MAJOR_CORRUPTION.getColouredName("b"),
                                        "<b>-6</b> "+Attribute.MAJOR_ARCANE.getColouredName("b"),
	...
	ARCANE_AROUSAL_3(5,
			...
			null, Util.newArrayListOfValues(
					"[style.colourExcellent(Greatly increased)] amount of power converted from [style.boldArousal(Arousal)]")),
	...
	TELEPATHIC_COMMUNICATION_1(true,
			...
			null, Util.newArrayListOfValues(
					"Start combat with ",
                                        "+25 "+Attribute.MAJOR_CORRUPTION.getColouredName("b")+" ",
	...
	TELEPATHIC_COMMUNICATION_2(3,
			...
			null, Util.newArrayListOfValues(
					"Projected Touch duration increased to [style.boldGood(5 turns)]")),
	TELEPATHIC_COMMUNICATION_3(5,
			SpellSchool.ARCANE,
			...
			null, Util.newArrayListOfValues(
					"[style.boldLust(Tease)] [style.boldExcellent(applies)]",
                                        "+25 "+Attribute.MAJOR_CORRUPTION.getColouredName("b")+"",
                                        "-6 "+Attribute.MAJOR_ARCANE.getColouredName("b")+"",
	...
	ARCANE_CLOUD_1(true,
			...
			null, Util.newArrayListOfValues(
					"[style.boldExcellent(Increased)] to ",
                                        "<b>-25</b> "+Attribute.RESISTANCE_LUST.getColouredName("b"))),
	ARCANE_CLOUD_2(5,
			SpellSchool.ARCANE,
			...
			null, Util.newArrayListOfValues(
					"<b>10</b> "+Attribute.DAMAGE_LUST.getColouredName("b")+" per turn")),
	ARCANE_CLOUD_3(5,
			SpellSchool.ARCANE,
			...
			null, Util.newArrayListOfValues(
					"[style.boldArcane(Lightning spells)] [style.boldExcellent(critically hit)] on targets affected by Localised Storm")),
